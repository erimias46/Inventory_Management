...
<div class="app-menu">
    ...
    <a href=" <?php echo $redirect_link ?>index.php" class="logo-box">
        ...
        <div class="logo-light">
            <img src="<?php echo $redirect_link ?>assets/images/pearl.jpg" class="logo-lg" style="height: 40px; width: 40px;" alt="Light Logo">
            <img src="<?php echo $redirect_link ?>assets/images/pearl.jpg" class="logo-sm" style="height: 40px; width: 40px;" alt="Small Light Logo">
        </div>

        <!-- Dark Brand Logo -->
        <div class="logo-dark">
            <img src="<?php echo $redirect_link ?>assets/images/pearl.jpg" class="logo-lg" style="height: 40px; width: 40px;" alt="Dark Logo">
            <img src="<?php echo $redirect_link ?>assets/images/pearl.jpg" class="logo-sm" style="height: 40px; width: 40px;" alt="Small Dark Logo">
        </div>
