                    ...
                    <div class="p-6">
                        <form method="POST">
                            ...
                            <div class="flex gap-1 ">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-input" name="stock_type">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM accessory_sales_log GROUP BY accessory_name";
                                        $result = mysqli_query($con, $sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                            <option value="<?php echo $row['accessory_name']; ?>">
                            ...
                            <a class="inline-flex items-center gap-2 mt-5 text-sm font-medium text-primary hover:text-sky-700" href="#">
                                <a href="accessory_stock_log.php" class="btn bg-danger text-white"><i class="fas fa-undo-alt"></i> Reset</a>
                                ...
                                <div class="overflow-hidden">
                                    <table id="myTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody>
                                            ...
                                            if ($stock_type != 'all') {
                                                $conditions[] = "accessory_name = '$stock_type'";
                                            }
                                            ...
                                            $sql = "SELECT * FROM accessory_sales_log $whereClause ORDER BY sales_id DESC";
                                            $result = mysqli_query($con, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
...
if (isset($_POST['filter'])) {
    ...
    echo "<script>window.location = 'accessory_stock_log.php?from_date=$from_date&to_date=$to_date&stock=$stock_type'; </script>";
}
