...
if (isset($_POST['deliver']) && isset($_POST['update'])) {
    foreach ($_POST['update'] as $update_id) {
        ...
        $generate_book = "INSERT INTO deliver(customer,job_description,size,quantity,total_price ,unit_price,price_vat ,types,remainder,advance,created_at) 
