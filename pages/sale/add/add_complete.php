                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="text-end">
                                ...
                                <button class="btn btn-sm bg-info text-white rounded-full" onclick="window.location.href='add_product.php'">Add Jeans</button>
                            </div>
                        </div>
                        <div class="p-6">
                            ...
                            <form method="post" enctype="multipart/form-data" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"  value="0" step="0.0000001" name="price"  class="form-input" required value="<?php if (isset($price)) echo  $price ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="image-preview" id="imagePreview">
                                        ...
                                        <img src="../../../include/uploads/defaultcomplete.jpg" />
                                    </div>
                                </div>
