...
if (isset($_POST['update'])) {
    ...
    if ($result) {
        echo "<script>window.location = 'action.php?status=success&redirect=all_product_type.php';</script>";

        //send notification

        $message = "Product Price Updated:\n";
        $message .= "Product Name: " . $shoes_name . "\n";
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            ...
                            <form method="post" enctype="multipart/form-data" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2" for="shoes names">Product Name</label>
                                    <input type="text" name="product_name" id="product_name" value="<?php if (isset($shoes_name)) echo  $shoes_name ?>" class="form-input" list="shoes_types" required>
