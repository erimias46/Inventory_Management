                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            if (!$customer) {
                                                ...
                                                $sql = "SELECT * FROM delivery WHERE DATE(sales_date) >= '$from_date' AND DATE(sales_date) <= '$to_date' AND {$customer} ORDER BY sales_id DESC";
                                            }
                                                        ...
                                                        <form method="POST" class="overflow-y-auto">
                                                            <div class="px-4 py-8">
                                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                                    ...
                                                                    $sql8 = "SELECT * from delivery WHERE sales_id = " . $row['sales_id'];
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="jeans_name" class="form-input" required value="<?php echo $row['jeans_name'] ?>">
                                                                    </div>
...
if (isset($_POST['add_data'])) {
 $user_id = $_SESSION['user_id'];
    ...
    if (!empty($jeans_name) && !empty($size)) {
        ...
        $message = "Jeans is going out for Delivery";
        ...
        $subject = "Sold Jeans Deliverd to Customer";
