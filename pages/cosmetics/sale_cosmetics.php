...
if ($result) {
    ...
    if ($row) {
        ...
        $editsalecosmetics = ($module['editsalecosmetics'] == 1) ? true : false;
        $deletesalecosmetics = ($module['deletesalecosmetics'] == 1) ? true : false;
        $exchangesalecosmetics = ($module['exchangesalecosmetics'] == 1) ? true : false;
        $refundsalecosmetics = ($module['refundsalecosmetics'] == 1) ? true : false;
    } else {
                                                        ...
                                                        <form method="POST" class="overflow-y-auto">
                                                            <div class="px-4 py-8">
                                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                                    ...
                                                                    <div>
                                                                        <label class="text-gray-800 text-sm font-medium inline-block mb-2">cosmetics Name</label>
                                                                        <select name="cosmetics_name" class="search-select" id="cosmetics_name_select" disabled>
                                                                            <?php
                                                                            $sql3 = "SELECT * FROM cosmetics GROUP BY cosmetics_name ORDER BY cosmetics_name ASC";
                                                                            $result3 = mysqli_query($con, $sql3);
                                                                            if (mysqli_num_rows($result3) > 0) {
                                                                                while ($row3 = mysqli_fetch_assoc($result3)) { ?>
                                                                                    <option value="<?= $row3['cosmetics_name'] ?>"
                                                                                        <?php
                                                                                        // Check if the current cosmetics_name should be selected
