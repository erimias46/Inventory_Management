                    ...
                    <div class="2xl:col-span-3">
                        <div class="grid xl:grid-cols-4 md:grid-cols-2 gap-6 mb-6">
                            ...
                            FROM (
                                ...
                                WHERE s.sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                                ...
                                WHERE ss.sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                                ...
                                WHERE acs.sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                                ...
                                WHERE cs.sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                            ) AS combined_profits";
                                            ...
                                            <h3 class="text-gray-500 mb-1 truncate dark:text-gray-400">
                                                Total Profit (<?= $selectedPeriod ?> Days)
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="p-6">
                                    <div class="flex justify-between items-center">
                                        <div class="w-20 h-20 mx-2 rounded-full inline-flex items-center justify-center bg-yellow-100">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <h4 class="text-gray-700 mt-1 text-xl font-bold mb-5 dark:text-gray-300">
                                                ...
                                                $interval = match ($selectedEarningsPeriod) {
                                                    '7' => '7 DAY',
                                                    '30' => '30 DAY',
                                                    '60' => '60 DAY',
                                                    '180' => '6 MONTH',
                            ...
                            AND sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                            UNION ALL
                            ...
                            AND sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)";
                                            ...
                                            <p class="text-gray-500 mb-1 truncate dark:text-gray-400">
                                                Total Earnings (<?= $selectedEarningsPeriod ?> Days)
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="text-right">
                                            ...
                                            $interval = match ($selectedQuantityPeriod) {
                                                '7' => '7 DAY',
                                                '30' => '30 DAY',
                                                '60' => '60 DAY',
                                                '180' => '6 MONTH',
                        ...
                        FROM (
                            ...
                            WHERE sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                                            ...
                                            <p class="text-gray-500 mb-1 truncate dark:text-gray-400">
                                                Total Quantity Sold (<?= $selectedQuantityPeriod ?> Days)
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        FROM (
                            ...
                            WHERE sales_date >= DATE_SUB(CURDATE(), INTERVAL $interval)
                                            ...
                                            <p class="text-gray-500 mb-1 truncate dark:text-gray-400">
                                                Total Sales (Last <?= $selectedPeriod ?> Days)
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="bg-white rounded-lg shadow-sm p-6">
                                                ...
                                                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                                                    ...
                                                    <form method="get" class="flex gap-3">
                                                        <select name="year" class="px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                    ...
                                                    <table class="min-w-full divide-y divide-gray-200">
                                                        <thead class="bg-blue-600">
                                                            <tr>
                                                                ...
                                                                <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Avg. Sale Price</th>
                                                                <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Avg. Profit</th>
                                                            </tr>
                                                        </thead>
...
";
                        ...
                        <div class="card p-6" data-simplebar style="max-height: 304px;">
                            ...
                            <?php
                            // Count different methods and statuses across all sales tables
                            $queries = [
                                'shop' => "SELECT COUNT(*) AS count FROM (
                    SELECT method FROM sales WHERE method = 'shop'
                    UNION ALL SELECT method FROM shoes_sales WHERE method = 'shop'
                    UNION ALL SELECT method FROM accessory_sales WHERE method = 'shop'
                    UNION ALL SELECT method FROM complete_sales WHERE method = 'shop'
                    UNION ALL SELECT method FROM top_sales WHERE method = 'shop'
                   ) AS combined",

                                'delivery' => "SELECT COUNT(*) AS count FROM (
                        SELECT method FROM sales WHERE method = 'delivery'
                        UNION ALL SELECT method FROM shoes_sales WHERE method = 'delivery'
                        UNION ALL SELECT method FROM accessory_sales WHERE method = 'delivery'
                        UNION ALL SELECT method FROM complete_sales WHERE method = 'delivery'
                        UNION ALL SELECT method FROM top_sales WHERE method = 'delivery'
                       ) AS combined",

                                'exchange' => "SELECT COUNT(*) AS count FROM (
                        SELECT status FROM sales WHERE status = 'exchange'
                        UNION ALL SELECT status FROM shoes_sales WHERE status = 'exchange'
                        UNION ALL SELECT status FROM accessory_sales WHERE status = 'exchange'
                        UNION ALL SELECT status FROM complete_sales WHERE status = 'exchange'
                        UNION ALL SELECT status FROM top_sales WHERE status = 'exchange'
                       ) AS combined",

                                'refund' => "SELECT COUNT(*) AS count FROM (
                      SELECT status FROM sales WHERE status = 'refund'
                      UNION ALL SELECT status FROM shoes_sales WHERE status = 'refund'
                      UNION ALL SELECT status FROM accessory_sales WHERE status = 'refund'
                      UNION ALL SELECT status FROM complete_sales WHERE status = 'refund'
                      UNION ALL SELECT status FROM top_sales WHERE status = 'refund'
                     ) AS combined"
                            ];
                                            ...
                                            ?>
                                                    <div class="flex items-center">
                                                        <div class="flex-shrink-0">
                                                            <i class="mgc_bank_card_line h-10 w-10 flex justify-center items-center rounded-full bg-blue-100 text-blue-500"></i>
                                                        </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="hidden fc-dropdown fc-dropdown-open:opacity-100 opacity-0 w-36 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
                                            ...
                                            <a href="?period=7" class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                                                Last 7 Days
                                            </a>
                                            <a href="?period=30" class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                                                Last 30 Days
                                            </a>
                                            <a href="?period=90" class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                                                Last 90 Days
                                            </a>
                                            <a href="?period=180" class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                                                Last 6 Months
                                            </a>
                                            <a href="?period=365" class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200">
                                                Last Year
                                            </a>
                                        </div>
                                    </div>
                            ...
                            LIMIT 10";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $status = $row['price'];
                                        ?>
                                                <div class="flex items-center w-full border border-gray-200 dark:border-gray-700 rounded p-2">
                                                    <p class="me-3 text-lg text-gray-300 dark:text-gray-500"><?= $int ?></p>
                                                    <div class="w-full overflow-hidden border-l border-gray-200 dark:border-gray-700 ps-3">
                                                        <div class="flex justify-between align-center">
                                                            <h5 class="font-semibold uppercase truncate text-gray-600 dark:text-gray-400">
                                                                <?php echo $client ?>
                                                            </h5>
