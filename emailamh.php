        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                <div class="card">
                    ...
                    <div class="p-6">
                        <form method="POST" action="include/pdf/emailamh.php">
                            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-3">

                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2"> ተቀባይ </label>
                                    <input type="text" name="to" class="form-input" required placeholder="ተቀባይ ስም">
                                </div>
                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2">ካምፓኒ አድራሻ </label>
                                    <input type="text" name="to_comp_add" class="form-input" required placeholder="ካምፓኒ አድራሻ">
                                </div>
                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2">ከተማ፣ ሃገር </label>
                                    <input type="text" name="to_city" class="form-input" required placeholder="አዲስ አበባ ፤ ኢትዮጵያ ">
                                </div>

                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2"> ላኪ </label>
                                    <input type="text" name="from" class="form-input" required>
                                </div>
                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2">ጉዳይ </label>
                                    <input type="text" name="subject" class="form-input" required>
                                </div>
                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2"> መልዕክት </label>
                                    <textarea name="email_body" class="form-input" required rows="5"></textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="text-gray-800 text-sm font-medium inline-block mb-2">መዝጊያ</label>
