                                ...
                                <div class="min-w-full inline-block align-middle">
                                    <div class="overflow-hidden">
                                        <table id="zero_config" data-order='[[ 1, "dsc" ]]' class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM accessory_verify order by id desc";
                                                ...
                                                ?>
                                                    <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-700 dark:even:bg-slate-800">
                                                        ...
                                                        <td>
                                                        <a href="api/verify.php?id=<?php echo $row['id']; ?>&from=accessory_verify" id="del-btn" class="btn bg-success/25 text-success hover:bg-success hover:text-white btn-sm rounded-full">
                                                            <i class="mgc_check_circle_line text-base me-2"></i>
                                                                Verify
                                                            </a>
                                                        <a href="api/remove.php?id=<?php echo $row['id']; ?>&from=accessory_verify" id="del-btn" class="btn bg-danger/25 text-danger hover:bg-danger hover:text-white btn-sm rounded-full">
                                                        ...
                                                        <td class="px-2.5 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200"><?php echo $row['accessory_name']; ?></td>
