                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex justify-between items-center">
                            <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Remainder</h4>
                            <div>
                                <a href="<?= $redirect_link . 'pages/export.php?type=remainder' ?>" class=" btn btn-sm rounded-full bg-success/25 text-success hover:bg-success hover:text-white">
                    ...
                    <div class="p-6">
                        <form method="POST" action="../include/pdf/index2.php">
