                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            if (!$customer) {
                                                ...
                                                $sql = "SELECT * FROM accessory_delivery WHERE DATE(sales_date) >= '$from_date' AND DATE(sales_date) <= '$to_date' AND {$customer} ORDER BY sales_id DESC";
                                            }
                                                        ...
                                                        <form method="POST" class="overflow-y-auto">
                                                            <div class="px-4 py-8">
                                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                                    ...
                                                                    $sql8 = "SELECT * from accessory_delivery WHERE sales_id = " . $row['sales_id'];
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="accessory_name" class="form-input" required value="<?php echo $row['accessory_name'] ?>">
                                                                    </div>
                                                            ...
                                                            <div class="flex justify-end items-center gap-4 p-4 border-t dark:border-slate-700">
                                                                ...
                                                                <button name="exchange_accessory" type="submit" class="btn bg-success text-white">Delivery</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
if (isset($_POST['add_data'])) {
    ...
    if (!empty($accessory_name) && !empty($size)) {
        ...
        if ($method == 'delivery') {
            ...
            $add_sales = "INSERT INTO `sales`(`accessory_id`, `size_id`, `accessory_name`, `size`, `price`, `cash`, `bank`, `method`, `sales_date`, `update_date`, `quantity`, `user_id`,`bank_id`,`bank_name`,`status`) 
            ...
            $add_accessory_log = "INSERT INTO `sales_log`(`accessory_id`, `size_id`, `accessory_name`, `size`, `price`, `cash`, `bank`, `method`, `sales_date`, `update_date`, `quantity`, `user_id`, `status`) 
        ...
        $message = "accessory is going out for Delivery \n";
