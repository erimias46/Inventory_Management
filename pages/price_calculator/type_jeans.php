                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <table id="zero_config" data-order='[[ 0, "dsc" ]]' class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT jeans_name, GROUP_CONCAT(CONCAT('Size ', size, ' (', quantity, 'X)') SEPARATOR ', ') AS sizes, price, image,created_at,id FROM jeans WHERE quantity > 0 GROUP BY jeans_name, price, image  ORDER BY created_at DESC";
                                                ...
                                                ?>
                                                    <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-700 dark:even:bg-slate-800 cursor-pointer">
                                                        ...
                                                        <td class="px-2 py-2.5 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200 text-ellipsis overflow-hidden" > <?php echo $row['sizes']; ?> </td>
