                            ...
                            <div class="flex gap-1 ">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-input" name="stock_type">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM sales_log GROUP BY jeans_name";
                                        $result = mysqli_query($con, $sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                            <option value="<?php echo $row['jeans_name']; ?>">
                                ...
                                <div class="overflow-hidden">
                                    <table id="myTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody>
                                            ...
                                            if ($stock_type != 'all') {
                                                $conditions[] = "jeans_name = '$stock_type'";
                                            }
                                            ...
                                            $sql = "SELECT * FROM sales_log $whereClause ORDER BY sales_id DESC";
                                            $result = mysqli_query($con, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-700 dark:even:bg-slate-800">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                        ...
                                                        if ($status == "add_quantity" || $status == "Refund") {
