                ...
                <div class="card overflow-hidden sm:rounded-md rounded-none">
                    <form class="p-6" method="POST">
                        <a href="index.php" class="block mb-8">
                            <img class="h-50 w-50 block mx-auto dark:hidden" src="assets/images/pearl.jpg" alt="">
                            <img class="h-50 w-50 hidden mx-auto dark:block" src="assets/images/pearl.jpg" alt="">
