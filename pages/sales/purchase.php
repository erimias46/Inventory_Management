                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="flex justify-between items-center">
                            <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Purchase</h4>
                            <div>
                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            if (!$customer) {
                                                ...
                                                $sql = "SELECT * FROM sales WHERE DATE(sales_date) >= '$from_date' AND DATE(sales_date) <= '$to_date' AND {$customer} ORDER BY sales_date DESC";
                                            }
                                            ...
                                            <tr
                                                ...
                                                <td
                                                    ...
                                                    <a id="del-btn" href="remove.php?id=<?php echo $row['sales_id'];?>&from=sales"
                                                ...
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                    <?php echo $row['machine_number']; ?></td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                    <?php echo $row['holding_tax']; ?></td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                    <?php echo $row['receipt_number']; ?></td>
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                        ...
                                                        <div class="px-4 py-8 overflow-y-auto">
                                                            ...
                                                            <input type="hidden" name="customer"
                                                                ...
                                                                <input type="text" name="receipt_number" class="form-input"
                                                                    value="<?= $row['receipt_number'] ?>" required>
                                                            </div>
                                                            
                                                            <div class="flex gap-2 justify-between">
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="text-gray-800 text-sm font-medium inline-block mb-2">Tin
                                                                        Number</label>
                                                        ...
                                                        <div class="flex gap-2 justify-between">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="vat"
                                                                    class="form-input" value="<?php echo $row['vat']; ?>"
                                                                    required>
                                                            </div>
                                                         </div>
                                                         ...
                                                         <div class="flex gap-2 justify-between">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="machine_number" class="form-input"
                                                                    value="<?= $row['machine_number'] ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label
                                                                    class="text-gray-800 text-sm font-medium inline-block mb-2">
                                                                ...
                                                                <input type="text" name="holding_tax"
                                                                    class="form-input" value="<?= $row['holding_tax'] ?>"
                                                                    required>
                                                            </div>
                                                         </div>
...
if (isset($_POST['add_data'])) {
    ...
    $add_data = "INSERT INTO `sales`(`customer`, `tin_number`, `price_before_vat`, `vat`, 
                `price_including_vat`, `machine_number`, `holding_tax`, `receipt_number`, 
                `sales_date`, `update_date`) 
                VALUES ('$customer','$tin_number','$price_before_vat','$vat',
                '$price_including_vat','$machine_number','$holding_tax','$receipt_number',
                '$date','$date')";
...
if (isset($_POST['filter'])) {
    ...
    $to = $_POST['to_date'];
    $customer = $_POST['customer'];
    echo "<script>window.location = 'purchase.php?from=$from&to=$to&customer=$customer'; </script>";
}
