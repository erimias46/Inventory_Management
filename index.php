                                ...
                                <div class="card">
                                    ...
                                    (SELECT SUM(price_including_vat)  
                                        ...
                                        <div class="status">
                                            ...
                                            <?php
                                            $last_month = isset($last_month) ? $last_month : 0;
                                            ?>
                                        ...
                                        <div class="flex justify-center">
                                            <div class="w-1/2 text-center">
                                                <h5>$ <?php echo number_format($sale, 2); ?></h5>
                                                <p class="fw-semibold text-muted">
                                                    <i class="mgc_round_fill text-primary"></i> Sales
                                                </p>
                                            </div>
                                            <div class="w-1/2 text-center">
                                                <h5>$ <?php echo number_format($purchase, 2); ?></h5>
                                                <p class="fw-semibold text-muted">
...
";
                            ...
                            <div class="flex flex-row justify-between ">
                                ...
                                <div class="card-title">
                                    ...
                                    <div
                                        ...
                                        <a href="pages/payment/payment_managment.php"
                                            class="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
                                            href="javascript:void(0)">
                                            <i class="mgc_info_circle_line"></i> Info
                                        </a>
               ...
               SUM(remained) AS total_remained, 
               SUM(total) AS total, 
        ...
        GROUP BY client  ORDER BY total_remained DESC;";
                            $result = mysqli_query($con, $sql);
                            ...
                            if ($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    $advance = $row['advance'];
                                    $remained = number_format($row['total_remained'], 2, '.', '');
                                    $total = number_format(
                                        $row['total'],
                                        2,
                                        '.',
                                    ...
                                    $progressBarClass = $remained > 50000 ? 'bg-red-500' : 'bg-primary';
                            ?>
                                    <div class="my-4">
                                        ...
                                        <div class="flex w-full h-1 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                            <div class="flex flex-col justify-center overflow-hidden <?php echo $progressBarClass; ?> w-1/2"
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex justify-space-evenly items-center">
                                    <h4 class="card-title  px-10">Verified Bank Statment</h4>
                                ...
                                <div class="grid md:grid-cols-2 items-center gap-4">
                                    <div class="md:order-1 order-2">
                                        <div class="flex flex-col gap-6">
                                            ...
                                            $sql = "SELECT name, SUM(info_amount) AS total_amount
FROM bank
WHERE verified = 1
GROUP BY name;
  ";
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="flex-grow ms-3">
                                                            ...
                                                            <ul class="flex items-center gap-2">
                                                                ...
                                                                <li class="list-inline-item"><b> <?php echo number_format($total_amount, 2) ?>
                                                                        Birr </b> </li>
                                                            </ul>
                                                        </div>
                                                    </div>
...
GROUP BY name";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                $bankData[] = array(
                                                    'name' => $row['name'],
                                                    'unverified_count' => $row['total_amount']
                                                );
                                            }
                                        }
                                        ?>
